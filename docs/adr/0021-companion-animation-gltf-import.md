...
**Status:** superseded by [ADR 0028](0031-animation-clip-independent-of-mesh.md) for Mesh↔Clip packaging, Intermediate layout, dependency-graph edges, and Reimport ownership.
...
**See also:** [ADR 0028](0031-animation-clip-independent-of-mesh.md), [CONTEXT.md — Companion Animation glTF](../../CONTEXT.md), [ADR 0019](0019-gltf-intermediate.md), [ADR 0020](0020-animation-player-two-slot-blend.md).
