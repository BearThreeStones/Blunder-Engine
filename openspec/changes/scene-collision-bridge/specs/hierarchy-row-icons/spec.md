...
#### Scenario: Present Collider and Character Controller
- **WHEN** an entity has a Collider Unique and a Character Controller Unique
- **THEN** the row shows Transform plus Collider and Character Controller icons
