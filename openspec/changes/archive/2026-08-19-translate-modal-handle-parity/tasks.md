...
- [x] 5.3 Build `engine_runtime` / relevant tests; run motion unit tests
- [x] 5.4 Manual QA (static camera): axis / plane / center drag feel; guides pinned; ghost; visibility; origin dot; cursor; outline; Escape/RMB cancel; LMB release confirm
