...
- [x] 2.4 Commit repo-root `project.blunder` (Dev Project); note in `CONTENT_LAYOUT.md`
...
- [ ] 4.2 Manual smoke: `project_manager` entry, Create & Open, Import Dev Project, Remove, missing mark, Debug `engine_editor` without CLI
