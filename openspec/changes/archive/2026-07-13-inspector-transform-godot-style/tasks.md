...
- [x] 4.2 Manual smoke: single-select type/scrub/slider, Scale link, Quaternion normalize, multi Absolute/Delta, rotation delta, focus lock + Esc
- [x] 4.3 Mark OpenSpec tasks complete; archive when ready per project workflow
