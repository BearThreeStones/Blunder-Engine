...
- [ ] 2.1 TDD: PaperMouth applies jaw pose from `openAmount`
- [ ] 2.2 TDD: configurable jaw bone name
- [ ] 2.3 TDD: optional attach-driven mode fills `openAmount` when enabled; default off
