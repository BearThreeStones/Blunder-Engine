...
- [ ] 1.1 Add Mesh Preview Render service API (load Mesh Final→Fast Path, frame AABB, studio lights, bind-pose for skinned) with unit/integration hooks for success/fail
- [ ] 1.2 Allocate dedicated offscreen RT + readback path (not Camera Preview / main viewport RT); document ownership next to Camera Preview
