...
- [x] 1.4 TDD: Fire does not use Crossfade by default; fade=0 / snap semantics under Phase 2 player
- [x] 1.5 Confirm Phase 1 rule: each Player still drives only co-located Skeleton (no remote Skeleton via Sync Group)
