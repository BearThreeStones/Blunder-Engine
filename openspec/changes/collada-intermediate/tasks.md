...
- [x] 2.2 Update cook freshness / watch path helpers and fixtures that assume Intermediate `.gltf`
- [x] 2.3 Tests: missing/stale Final Fast Path from `.dae`; fresh Final preferred; Intermediate `.dae` change invalidates Final
