...
Authors place a Unique Fog Component in the Scene Asset so Viewport and Player volumetric fog have an enable gate, height-density source, and view distance — not a hidden process-global fog rig.
