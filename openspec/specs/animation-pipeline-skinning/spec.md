# animation-pipeline-skinning Specification

## Purpose
Skinning paths consume the Animation Pipeline Matrix Palette after evaluate; draw bridge is not the authoritative palette author for evaluated Skeletons.
