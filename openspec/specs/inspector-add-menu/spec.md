# inspector-add-menu Specification

## Purpose

Inspector Add… is the single authorship picker for attaching Camera, Light, animation hosts, Behaviours, and SkeletonModifiers to the current selection without collapsing ClassDB and ECS into one Component type.
