# translate-modal-session Specification

## Purpose

Shared Translate Modal Session for moving a selection: handle-started drag owns screen-space motion, constraints, confirm/cancel, and drag feedback. Grab entry and mid-session constraints extend this capability in later changes.
