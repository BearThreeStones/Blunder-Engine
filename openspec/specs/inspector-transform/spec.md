# inspector-transform Specification

## Purpose
Godot-like Local Transform Inspector: axis-colored TRS fields, typed commit and scrub, Scale link, Euler|Quaternion edit mode, and multi-select Absolute/Delta (rotation delta-only), with Quaternion as authoritative storage.
