# editor-mesh-hot-reload Specification

## Purpose
Session Mesh presentation refresh after successful Mesh Reimport so viewport, Mesh Preview, and placed meshes update without restarting the editor.
