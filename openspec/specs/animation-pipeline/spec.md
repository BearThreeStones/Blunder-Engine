...
## Purpose
First-class per-Object Animation Pipeline evaluation: clip clocks and blend specifications to Local Pose, Global Pose, and Matrix Palette, with PoseApplied after stage 6.
