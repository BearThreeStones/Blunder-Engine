...
struct NativeFloatPanelSnapshot {
  ...
  bool inspector_has_collider{false};
  int inspector_collider_shape{0};
  int inspector_collider_body{0};
  float inspector_collider_layer{1.0f};
  float inspector_collider_mask{-1.0f};
  float inspector_collider_box_x{1.0f};
  float inspector_collider_box_y{1.0f};
  float inspector_collider_box_z{1.0f};
  float inspector_collider_sphere_radius{0.5f};
  float inspector_collider_capsule_radius{0.5f};
  float inspector_collider_capsule_height{2.0f};
  bool inspector_collider_expanded{true};
  bool inspector_has_character_controller{false};
  float inspector_cct_radius{0.4f};
  float inspector_cct_height{1.8f};
  float inspector_cct_slope_limit{45.0f};
  float inspector_cct_step_height{0.3f};
  float inspector_cct_snap{0.2f};
  float inspector_cct_skin{0.04f};
  float inspector_cct_mask{-1.0f};
  bool inspector_character_controller_expanded{true};
  eastl::string inspector_groups_text;
...
class DockFloatingWindowHost final {
 public:
  ...
  struct Callbacks {
    ...
    std::function<void(bool)> on_inspector_collider_edited;
    std::function<void(bool)> on_inspector_character_controller_edited;
    std::function<void()> on_inspector_groups_edited;
